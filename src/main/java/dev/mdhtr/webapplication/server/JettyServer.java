...
import dev.mdhtr.webapplication.server.error.ConstraintViolationExceptionMapper;
import dev.mdhtr.webapplication.server.error.DefaultExceptionMapper;
import dev.mdhtr.webapplication.server.error.JsonGeneralExceptionMapper;
import dev.mdhtr.webapplication.server.error.JsonUnrecognizedPropertyExceptionMapper;
import dev.mdhtr.webapplication.server.error.WebApplicationExceptionMapper;
...
public class JettyServer {
    ...
    private static final String STATIC_CONTENT_RESOURCE_PATH = "/dev/mdhtr/webapplication/public/";
